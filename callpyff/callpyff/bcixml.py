...
from callpyff import pylibtobiic
...
class TobiXmlDecoder(XmlDecoder):
    ...
    def __decode_tobiic_packet(self, data):
        ...
        for classifier_name in list(icmessage.classifiers.map.keys()):
            ...
            values = []
            for class_name in list(classifier_data.classes.map.keys()):
